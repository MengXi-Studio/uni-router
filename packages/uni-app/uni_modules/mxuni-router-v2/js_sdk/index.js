import { createStartLocation, __publicField, DEFAULT_READY_TIMEOUT, DEFAULT_GUARD_TIMEOUT, createParamsManager, RouterError, NavigationFailure, isUniApiError, ROUTER_SYMBOL, getPlatform, MAX_REDIRECT_DEPTH, buildFullPath, createRouteLocation, warn, normalizePath, safeGetCurrentPages, isSameQuery, isObject, DEFAULT_ANIMATION_DURATION, markRouterCall, UniApiError, parseQuery, serializeQuery, PARAMS_KEY } from './chunk-4Y6NILT2.js';
export { AnimationPlugin, ChannelPlugin, DEFAULT_ANIMATION_DURATION, InterceptorPlugin, NavigationFailure, ParamsPlugin, ROUTER_SYMBOL, RouterError, RouterErrorCode, UniApiError, UniEventChannel, isNavigationFailure, noopChannel, onBeforeRouteLeave, useLink, usePageChannel, useRoute, useRouter } from './chunk-4Y6NILT2.js';
