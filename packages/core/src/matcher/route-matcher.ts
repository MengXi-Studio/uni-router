import type { RouteConfig, RouteLocation, RouteLocationNamedRaw, RouteLocationPathRaw, RouteLocationRaw, RouteMeta, ParamObject } from '@/types'
...
import type { PathRouteMap, NameRouteMap } from './types'
...
export function createRouteMatcher(routes: RouteConfig[], strict: boolean, paramsManager: ParamsManager): RouteMatcher {
	const pathMap: PathRouteMap = new Map()
	const nameMap: NameRouteMap = new Map()
